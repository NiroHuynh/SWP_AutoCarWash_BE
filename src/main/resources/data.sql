...
VALUES
    ...
    (8,  NULL, 3,    'VNPAY', 1350000, 'TXN-0000000008', 'SUCCESS', DATE_SUB(NOW(), INTERVAL 20 DAY),   1350000,'SUBSCRIPTION'),
    ...
    (14, NULL, 10,   'CASH',  3200000, NULL,            'SUCCESS', DATE_SUB(NOW(), INTERVAL 20 DAY),   3200000,'SUBSCRIPTION'),
...
VALUES
    ...
    ('PENDING_PAYMENT_TIMEOUT_MINUTES', '15',  'Minutes a PENDING booking may await deposit transfer before auto-cancel', 'NUMBER', true),
